<section id="card" class="card" aria-labelledby="titleSection">
  <header class="card-header text-center">
    <h2 id="titleSection">Declaración Universal de los Derechos Humanos</h2>
  </header>
  <article class="card-body">
    <p>Fuente: <a href="https://www.un.org/es/about-us/universal-declaration-of-human-rights">Naciones Unidas - Declaración Universal de los Derechos Humanos</a></p>
    <p class="grey-well">La <span class="pdf-link"><a href="https://www.ohchr.org/EN/UDHR/Documents/UDHR_Translations/spn.pdf">Declaración Universal de los Derechos Humanos</a></span> es un documento que marca un hito en la historia de los derechos humanos. Elaborada por representantes de todas las regiones del mundo con diferentes antecedentes jurídicos y culturales, la Declaración fue proclamada por la Asamblea General de las Naciones Unidas en París, el 10 de diciembre de 1948 en su (<span class="pdf-link"><a href="https://undocs.org/es/A/RES/217(III)">Resolución 217 A (III)</a></span>) como un ideal común para todos los pueblos y naciones. La Declaración establece, por primera vez, los derechos humanos fundamentales que deben protegerse en el mundo entero y ha sido <a href="http://www.ohchr.org/EN/UDHR/Documents/UDHR_Translations/spn.pdf">traducida a más de 500 idiomas</a>.&nbsp;La DUDH es ampliamente reconocida por haber inspirado y allanado el camino para la adopción de más de setenta tratados de derechos humanos, que se aplican hoy en día de manera permanente a nivel mundial y regional (todos contienen referencias a ella en sus preámbulos).&nbsp;</p>

    <h3 class="heading-underlined-blue">Preámbulo</h3>
    ...
    <p>Proclama la presente Declaración Universal de los Derechos Humanos como ideal común por el que todos los pueblos y naciones deben esforzarse, a fin de que tanto los individuos como las instituciones, inspirándose constantemente en ella, promuevan, mediante la enseñanza y la educación, el respeto a estos derechos y libertades, y aseguren, por medidas progresivas de carácter nacional e internacional, su reconocimiento y aplicación universales y efectivos, tanto entre los pueblos de los Estados Miembros como entre los de los territorios colocados bajo su jurisdicción. &nbsp;</p>

    <h3 class="heading-underlined-blue">Artículo 1</h3>
    ...
    <h3 class="heading-underlined-blue">Artículo 8</h3>
    ...
    <h3 class="heading-underlined-blue">Artículo 9</h3>

    <p>Nadie podrá ser arbitrariamente detenido, preso ni desterrado.</p>

    <h3 class="heading-underlined-blue">Artículo 10</h3>
    ...
    <h3 class="heading-underlined-blue">Artículo 11</h3>
    <ol>
      ...
      <li>Nadie será condenado por actos u omisiones que en el momento de cometerse no fueron delictivos según el Derecho nacional o internacional. Tampoco se impondrá pena más grave que la aplicable en el momento de la comisión del delito.</li>
    </ol>

    <h3 class="heading-underlined-blue">Artículo 12</h3>
    ...
    <h3 class="heading-underlined-blue">Artículo 13</h3>
    ...
    <h3 class="heading-underlined-blue">Artículo 14</h3>

    <ol>
      <li>En caso de persecución, toda persona tiene derecho a buscar asilo, y a disfrutar de él, en cualquier país.</li>
      <li>Este derecho no podrá ser invocado contra una acción judicial realmente originada por delitos comunes o por actos opuestos a los propósitos y principios de las Naciones Unidas.</li>
    </ol>

    <h3 class="heading-underlined-blue">Artículo 15</h3>
    ...
    <h3 class="heading-underlined-blue">Artículo 16</h3>
    ...
    <h3 class="heading-underlined-blue">Artículo 17</h3>
    ...
    <h3 class="heading-underlined-blue">Artículo 18</h3>
    ...
    <h3 class="heading-underlined-blue">Artículo 19</h3>
    ...
    <h3 class="heading-underlined-blue">Artículo 20</h3>
    ...
    <h3 class="heading-underlined-blue">Artículo 21</h3>
    ...
    <h3 class="heading-underlined-blue">Artículo 22</h3>
    ...
    <h3 class="heading-underlined-blue">Artículo 23</h3>
    ...
    <ol>
      ...
      <li>Toda persona que trabaja tiene derecho a una remuneración equitativa y satisfactoria, que le asegure, así como a su familia, una existencia conforme a la dignidad humana y que será completada, en caso necesario, por cualesquiera otros medios de protección social.</li>
      <li>Toda persona tiene derecho a fundar sindicatos y a sindicarse para la defensa de sus intereses.</li>
    </ol>

    <h3 class="heading-underlined-blue">Artículo 24</h3>
    ...
    <h3 class="heading-underlined-blue">Artículo 25</h3>
    ...
    <ol>
      ...
      <li>La maternidad y la infancia tienen derecho a cuidados y asistencia especiales. Todos los niños, nacidos de matrimonio o fuera de matrimonio, tienen derecho a igual protección social.</li>
    </ol>

    <h3 class="heading-underlined-blue">Artículo 26</h3>
    ...
    <ol>
      ...
      <li>La educación tendrá por objeto el pleno desarrollo de la personalidad humana y el fortalecimiento del respeto a los derechos humanos y a las libertades fundamentales; favorecerá la comprensión, la tolerancia y la amistad entre todas las naciones y todos los grupos étnicos o religiosos, y promoverá el desarrollo de las actividades de las Naciones Unidas para el mantenimiento de la paz.</li>
      <li>Los padres tendrán derecho preferente a escoger el tipo de educación que habrá de darse a sus hijos.</li>
    </ol>

    <h3 class="heading-underlined-blue">Artículo 27</h3>
    ...
    <h3 class="heading-underlined-blue">Artículo 28</h3>
    ...
    <h3 class="heading-underlined-blue">Artículo 29</h3>
    ...
    <ol>
      ...
      <li>En el ejercicio de sus derechos y en el disfrute de sus libertades, toda persona estará solamente sujeta a las limitaciones establecidas por la ley con el único fin de asegurar el reconocimiento y el respeto de los derechos y libertades de los demás, y de satisfacer las justas exigencias de la moral, del orden público y del bienestar general en una sociedad democrática.</li>
    ...
    <h3 class="heading-underlined-blue">Artículo 30</h3>
