                ...
                options: [{
                    ...
                    value: function(rowData, rowIdx) {
                      if (rowData !== undefined) {
                        return rowData['category'].includes('Adaptabilidad');
                      }
                      return true;
                    }
                  },
                  {
                    ...
                    value: function(rowData, rowIdx) {
                      if (rowData !== undefined) {
                        return rowData['category'].includes('Botones');
                      }
                      return true;
                    }
                  },
                  ...
                  },
                  {
                    ...
                    value: function(rowData, rowIdx) {
                      if (rowData !== undefined) {
                        return rowData['category'].includes('Componentes');
                      }
                      return true;
                    }
                  },
                  ...
                  },
                  {
                    ...
                    value: function(rowData, rowIdx) {
                      if (rowData !== undefined) {
                        return rowData['category'].includes('Imágenes');
                      }
                      return true;
                    }
                  },
                  {
                    ...
                    value: function(rowData, rowIdx) {
                      if (rowData !== undefined) {
                        return rowData['category'].includes('Multimedia');
                      }
                      return true;
                    }
                  },
                  {
                    ...
                    value: function(rowData, rowIdx) {
                      if (rowData !== undefined) {
                        return rowData['category'].includes('Navegación');
                      }
                      return true;
                    }
                  },
                  {
                    ...
                    value: function(rowData, rowIdx) {
                      if (rowData !== undefined) {
                        return rowData['category'].includes('Semántica');
                      }
                      return true;
                    }
                  },
                  {
                    ...
                    value: function(rowData, rowIdx) {
                      if (rowData !== undefined) {
                        return rowData['category'].includes('Sensorial');
                      }
                      return true;
                    }
                  },
                  {
                    ...
                    value: function(rowData, rowIdx) {
                      if (rowData !== undefined) {
                        return rowData['category'].includes('Teclado');
                      }
                      return true;
                    }
                  },
